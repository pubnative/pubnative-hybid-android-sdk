...
class MaxAdsMediationMRectVideoFragment : Fragment(R.layout.fragment_maxads_mrect), MaxAdViewAdListener {
    val TAG = MaxAdsMediationMRectVideoFragment::class.java.simpleName
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adUnitId = SettingsManager.getInstance(requireActivity())
            .getSettings().maxAdsSettings?.mRectVideoAdUnitId
