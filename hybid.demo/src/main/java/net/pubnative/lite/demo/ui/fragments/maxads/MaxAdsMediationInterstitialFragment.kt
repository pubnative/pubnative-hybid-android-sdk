...
class MaxAdsMediationInterstitialFragment : Fragment(R.layout.fragment_maxads_interstitial),
    MaxAdListener {
    val TAG = MaxAdsMediationInterstitialFragment::class.java.simpleName
