...
class MarkupLeaderboardViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), MRAIDViewListener, MRAIDNativeFeatureListener {
    ...
    fun bind(markup: String) {
        if (!TextUtils.isEmpty(markup)) {
            ...
            val leaderboard = MRAIDBanner(itemView.context,
                    "",
                    markup,
                    supportedFeatures,
                    this,
