...
import net.pubnative.lite.demo.ui.fragments.ironsource.IronSourceMediationInterstitialFragment

class IronSourceMediationInterstitialActivity : TabActivity() {
