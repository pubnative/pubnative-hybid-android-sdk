...
class ChartboostMediationRewardedFragment : Fragment(R.layout.fragment_chartboost_rewarded),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        heliumPlacementName = SettingsManager.getInstance(requireActivity()).getSettings()
            .chartboostSettings?.mediationRewardedAdUnitId
    ...
    private fun loadAd() {
        if (adRequest != null) {
            lifecycleScope.launch(Dispatchers.IO) {
                loadResult = HeliumSdk.loadFullscreenAd(requireContext(), adRequest!!, this@ChartboostMediationRewardedFragment)
