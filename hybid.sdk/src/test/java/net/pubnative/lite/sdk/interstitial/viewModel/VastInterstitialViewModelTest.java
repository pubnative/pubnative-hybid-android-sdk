...
public class VastInterstitialViewModelTest {

    private VastInterstitialViewModel viewModel;
    private Application application;
    @Mock
    InterstitialActivityInteractor interactor;
    @Mock
    Ad mockAd;
    @Mock
    VideoAd mockVideoAd;
    ...
    public void setUp() {
        ...
        viewModel = new VastInterstitialViewModel(application, "zone1", "integration", 5, 123L, interactor);

        // Inject a fake Ad and VideoAd via reflection since they are private
        replacePrivateVariableWithMock(InterstitialViewModel.class, "mAd", mockAd);

        replacePrivateVariableWithMock(VastInterstitialViewModel.class, "mVideoAd", mockVideoAd);

        replacePrivateVariableWithMock(InterstitialViewModel.class, "mAdEventTracker", adTracker);
    }
    ...
    public void testPauseAndResumeAd_whenAdIsReady() {
        ...
        replacePrivateVariableWithMock(VastInterstitialViewModel.class, "mReady", true);
        replacePrivateVariableWithMock(VastInterstitialViewModel.class, "mIsVideoFinished", true);
        viewModel.pauseAd();
        viewModel.resumeAd();
    ...
    public void testPauseAndResumeAd_whenAdIsNotReady() {
        when(mockVideoAd.isAdStarted()).thenReturn(true);
        replacePrivateVariableWithMock(VastInterstitialViewModel.class, "mReady", false);
        replacePrivateVariableWithMock(VastInterstitialViewModel.class, "mIsVideoFinished", false);
        viewModel.pauseAd();
        viewModel.resumeAd();
    ...
    public void testRenderVastAd_withoutAd_fallsBackToError() throws Exception {
        // mAd = null
        replacePrivateVariableWithMock(InterstitialViewModel.class, "mAd", null);
    ...
    public void testOnImpressionAndShowButton() {
        ...
        verify(interactor, atLeastOnce()).showInterstitialCloseButton(any());
    }
    ...
    private void replacePrivateVariableWithMock(Class c, String fieldName, Object b) {
        try {
            Class<?> runnerClass = Class.forName("net.pubnative.lite.sdk.interstitial.viewModel.VastInterstitialViewModel");
