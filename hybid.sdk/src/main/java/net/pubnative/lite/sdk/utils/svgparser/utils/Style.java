...
public class  Style implements Cloneable
{
   ...
   static Style  getDefaultStyle()
   {
      ...
      def.fill = SVGBase.Colour.BLACK;
      def.fillRule = FillRule.NonZero;
      def.fillOpacity = 1f;
      def.stroke = null;         // none
      def.strokeOpacity = 1f;
      def.strokeWidth = new SVGBase.Length(1f);
      def.strokeLineCap = LineCap.Butt;
      def.strokeLineJoin = LineJoin.Miter;
      def.strokeMiterLimit = 4f;
      def.strokeDashArray = null;
      def.strokeDashOffset = SVGBase.Length.ZERO;
      def.opacity = 1f;
      def.color = SVGBase.Colour.BLACK; // currentColor defaults to black
      def.fontFamily = null;
      def.fontSize = new SVGBase.Length(12, SVGBase.Unit.pt);
      ...
      def.stopColor = SVGBase.Colour.BLACK;
      def.stopOpacity = 1f;
      def.clipPath = null;
      ...
      def.letterSpacing = SVGBase.Length.ZERO;
      def.wordSpacing = SVGBase.Length.ZERO;
