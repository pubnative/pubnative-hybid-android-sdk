...
public class CapabilitiesMacros {
    ...
    CapabilitiesMacros(BaseViewabilityManager viewabilityManager) {
        // All VAST versions
        ...
        if (viewabilityManager != null && viewabilityManager.getPartner() != null) {
            mOmidPartner = EncodingUtils.urlEncode(String.format(Locale.ENGLISH, "%s/%s", viewabilityManager.getPartnerName(), viewabilityManager.getSdkVersion()));
        } else {
