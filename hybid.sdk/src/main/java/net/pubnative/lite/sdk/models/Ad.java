...
//        }
    ...
    public String getBcLearnMoreSize() {
        String size = getRemoteConfig(RemoteConfig.BC_LEARN_MORE_SIZE);
        if (TextUtils.isEmpty(size)) {
            return LearnMoreSize.DEFAULT.getSizeName();
        }
    ...
    public String getBcLearnMoreLocation() {
        String location = getRemoteConfig(RemoteConfig.BC_LEARN_MORE_LOCATION);
        if (TextUtils.isEmpty(location)) {
            return LearnMoreLocation.DEFAULT.getLocationName();
        }
