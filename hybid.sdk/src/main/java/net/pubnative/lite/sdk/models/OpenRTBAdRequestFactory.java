...
public class OpenRTBAdRequestFactory extends BaseRequestFactory implements AdRequestFactory {
    ...
    private void processAdvertisingId(String appToken, String zoneId, AdSize adSize, String advertisingId, boolean limitTracking, boolean paAvailable, Callback callback) {
        if (callback != null) {
    ...
    Imp getBannerImpression(AdSize adSize, String mediationVendor, IntegrationType integrationType) {
        ...
        imp.setDisplaymanager(mDisplayManager.getDisplayManagerName());
