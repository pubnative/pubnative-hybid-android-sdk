...
public abstract class InterstitialViewModel extends BaseViewModel implements PNAPIContentInfoView.ContentInfoListener {
    ...
    private static final String TAG = InterstitialViewModel.class.getSimpleName();
    ...
    public InterstitialViewModel(Context context, String zoneId, String integrationType, int skipOffset, long broadcastId, InterstitialActivityInteractor listener) {
        ...
        mBroadcastSender = new HyBidInterstitialBroadcastSender(context, broadcastId);
    ...
    public void onIconClicked(List<String> clickTrackers) {
        ...
        invokeOnContentInfoClick(mIntegrationType, mAd, Reporting.AdFormat.FULLSCREEN);
    }
    ...
    public void processInterstitialAd() {
        if (isValidAdToRender()) {
            ...
            if (view != null) {
                ...
                if (!(this instanceof VastInterstitialViewModel) && shouldShowContentInfo() && mAd != null) {
