...
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.ClipPath;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Colour;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.CurrentColor;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Ellipse;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.GradientElement;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.GradientSpread;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.GraphicsElement;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Group;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Image;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Length;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Length.PERCENT_100;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Line;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Marker;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Mask;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.NotDirectlyRendered;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.PaintReference;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.PathDefinition;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.PathInterface;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Pattern;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.PolyLine;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Polygon;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Rect;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.SolidColor;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Stop;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Svg;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.SvgConditional;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.SvgContainer;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.SvgElement;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.SvgElementBase;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.SvgLinearGradient;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.SvgObject;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.SvgPaint;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.SvgRadialGradient;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Switch;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Symbol;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.TRef;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.TSpan;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Text;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.TextContainer;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.TextPath;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.TextSequence;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Unit;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.Use;
import static net.pubnative.lite.sdk.utils.svgparser.utils.SVGBase.View;
...
public class SVGAndroidRenderer
{
   ...
   */
   ...
   private boolean  pushLayer(float opacityAdjustment)
   {
      ...
      if (SUPPORTS_BLEND_MODE && state.style.mixBlendMode != Style.CSSBlendMode.normal) {
   ...
   private boolean requiresCompositing()
   {
      return (state.style.opacity < 1.0f) ||
             (state.style.mask != null) ||
             (state.style.isolation == Style.Isolation.isolate) ||
             (SUPPORTS_BLEND_MODE && state.style.mixBlendMode != Style.CSSBlendMode.normal);
   }
   ...
   private void selectTypefaceAndFontStyling()
   {
      ...
      if (SUPPORTS_PAINT_FONT_VARIATION_SETTINGS) {
         ...
         if (state.style.fontStyle == Style.FontStyle.italic) {
         ...
         else if (state.style.fontStyle == Style.FontStyle.oblique)
            state.fontVariationSet.addSetting(CSSFontVariationSettings.VARIATION_OBLIQUE, CSSFontVariationSettings.VARIATION_OBLIQUE_VALUE_ON);
   ...
   {
      if (state.style.direction == Style.TextDirection.LTR || state.style.textAnchor == Style.TextAnchor.Middle)
         return state.style.textAnchor;

      // Handle RTL case where Start and End are reversed
      return (state.style.textAnchor == Style.TextAnchor.Start) ? Style.TextAnchor.End : Style.TextAnchor.Start;
   }
   ...
   private void render(Image obj)
   {
      ...
      Paint  bmPaint = new Paint((state.style.imageRendering == Style.RenderQuality.optimizeSpeed) ? 0 : Paint.FILTER_BITMAP_FLAG);
   ...
   private void  updateStyle(RendererState state, Style style)
   {
      ...
      if (isSpecified(style, Style.SPECIFIED_TEXT_DECORATION))
      {
         ...
         state.fillPaint.setStrikeThruText(style.textDecoration == Style.TextDecoration.LineThrough);
         state.fillPaint.setUnderlineText(style.textDecoration == Style.TextDecoration.Underline);
         ...
         if (SUPPORTS_STROKED_UNDERLINES) {
            state.strokePaint.setStrikeThruText(style.textDecoration == Style.TextDecoration.LineThrough);
            state.strokePaint.setUnderlineText(style.textDecoration == Style.TextDecoration.Underline);
         }
      }
   ...
   private Typeface  checkGenericFont(String fontName, Float fontWeight, Style.FontStyle fontStyle)
   {
      Typeface font = null;
      int      typefaceStyle;
   ...
   private void  makeLinearGradient(boolean isFill, Box boundingBox, SvgLinearGradient gradient)
   {
      ...
      if (userUnits)
      {
         ...
         _x2 = (gradient.x2 != null) ? gradient.x2.floatValueX(this): PERCENT_100.floatValueX(this);  // default is 1.0/100%
