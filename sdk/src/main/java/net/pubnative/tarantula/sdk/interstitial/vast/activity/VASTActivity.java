package net.pubnative.tarantula.sdk.interstitial.vast.activity;
...
import net.pubnative.tarantula.sdk.interstitial.vast.model.TRACKING_EVENTS_TYPE;
import net.pubnative.tarantula.sdk.interstitial.vast.model.VASTModel;
import net.pubnative.tarantula.sdk.interstitial.vast.util.Assets;
import net.pubnative.tarantula.sdk.interstitial.vast.util.HttpTools;
...
public class VASTActivity extends Activity implements MediaPlayer.OnCompletionListener,
        MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener,
        MediaPlayer.OnVideoSizeChangedListener, SurfaceHolder.Callback {

    private static String TAG = VASTActivity.class.getSimpleName();
