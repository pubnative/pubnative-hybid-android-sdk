...
public class TarantulaMoPubMRectCustomEvent extends CustomEventBanner implements MRectPresenter.Listener {
    @NonNull
    private static final String TAG = TarantulaMoPubMRectCustomEvent.class.getSimpleName();
