...
public class Constants {
    ...
    public static final String BANNER_MRAID_PLACEMENT = "tarantula-mraid-banner";
    public static final String BANNER_MRAID_ZONE_ID = "2";

    public static final String INTERSTITIAL_MRAID_PLACEMENT = "tarantula-mraid-interstitial";
    ...
    public static final String MEDIUM_MRAID_PLACEMENT = "tarantula-mraid-medium";
    public static final String MEDIUM_MRAID_ZONE_ID = "5";

    public static final String MEDIUM_VIDEO_PLACEMENT = "tarantula-video-medium";
    ...
    public static final String MOPUB_VIDEO_MEDIUM_AD_UNIT = "";
}
