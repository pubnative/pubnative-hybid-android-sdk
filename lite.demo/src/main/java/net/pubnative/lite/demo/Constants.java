...
public class Constants {
    ...
    public static final String DFP_MRAID_BANNER_AD_UNIT = "pnlite_dfp_banner";
    public static final String DFP_MRAID_INTERSTITIAL_AD_UNIT = "pnlite_dfp_interstitial";
    public static final String DFP_MRAID_MEDIUM_AD_UNIT = "pnlite_dfp_mrect";
